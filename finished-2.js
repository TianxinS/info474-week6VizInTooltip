...
function makeScatterPlot(csvData) {
    ...
    data = csvData.filter(function(d) {return  d.year == '1980' & data.fertility != "NA" && data.life_expectancy != "NA";})
    ...
    makeLabels(svgContainer, msm, "Countries by Life Expectancy and Fertility Rate (2018)",'Fertility Rates (Avg Children per Woman)','Life Expectancy (years)');
}
...
function makeLabels(svgContainer, msm, title, x, y) {
    ...
    svgContainer.append('text')
    .attr('x', msm.width/2 -25)
    .attr('y', msm.height - msm.marginAll + 40)
    ...
    .append('circle')
        ...
        .attr("class", "circles")
            ...
            .on("mouseover", (d) => {
                ...
                div// div.html("Fertility:       " + d.fertility + "<br/>" +
